...
items requiring the same
<span class="keyword parmname">PrepInstruction</span> have different
<span class="keyword parmname">PrepOwners</span>. Because each shipment
must have the same <span class="keyword parmname">PrepOwner</span> for a
