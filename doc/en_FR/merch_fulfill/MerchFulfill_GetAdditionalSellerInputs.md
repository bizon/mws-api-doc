...
<tbody>
<tr class="odd">
<td><span class="keyword parmname">OrderId</span></td>
<td>An Amazon-defined order identifier. Use the <span class="keyword parmname">AmazonOrderId</span> value that you specified in a previous call to the <a href="MerchFulfill_GetEligibleShippingServices.md" class="xref" title="Returns a list of shipping service offers.">GetEligibleShippingServices</a> operation.</td>
<td>Yes</td>
<td><span class="ph">Type: xs:string</span></td>
</tr>
<tr class="even">
<td><span class="keyword parmname">ShippingServiceId</span></td>
<td>The identifier for the carrier shipping service that the seller chose. This was returned by a previous call to the <a href="MerchFulfill_GetEligibleShippingServices.md" class="xref" title="Returns a list of shipping service offers.">GetEligibleShippingServices</a> operation.
...
<td>The address from which the shipment ships. Use the <span class="keyword parmname">ShipFromAddress</span> value that you specified in a previous call to the <a href="MerchFulfill_GetEligibleShippingServices.md" class="xref" title="Returns a list of shipping service offers.">GetEligibleShippingServices</a> operation.</td>
<td>Yes</td>
