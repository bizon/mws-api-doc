...
<tr class="header row">
<th id="d323090e169" class="entry" data-valign="top" width="28.57142857142857%">Name</th>
<th id="d323090e172" class="entry" data-valign="top" width="28.57142857142857%">Description</th>
<th id="d323090e175" class="entry" data-valign="top" width="14.285714285714285%">Required</th>
<th id="d323090e178" class="entry" data-valign="top" width="28.57142857142857%">Valid values</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry" data-valign="top" width="28.57142857142857%" headers="d323090e169 "><span class="keyword parmname">MarketplaceId</span></td>
<td class="entry" data-valign="top" width="28.57142857142857%" headers="d323090e172 ">The unique identifier for the marketplace.</td>
<td class="entry" data-valign="top" width="14.285714285714285%" headers="d323090e175 ">Yes</td>
<td class="entry" data-valign="top" width="28.57142857142857%" headers="d323090e178 ">Any valid <span class="keyword parmname">MarketplaceId</span> that you are registered in. <span class="ph">For a list of <span class="keyword parmname">MarketplaceId</span> values, see <a href="../dev_guide/DG_Endpoints.md" class="xref">Amazon MWS endpoints and MarketplaceId values</a> in the <span class="ph">Amazon MWS Developer Guide</span>.</span>
...
<thead class="thead" data-align="left">
<tr class="header row">
<th id="d323090e244" class="entry" data-valign="top" width="50%">Name</th>
<th id="d323090e247" class="entry" data-valign="top" width="50%">Description</th>
</tr>
</thead>
<tbody class="tbody">
<tr class="odd row">
<td class="entry" data-valign="top" width="50%" headers="d323090e244 "><span class="keyword parmname">DestinationList</span></td>
<td class="entry" data-valign="top" width="50%" headers="d323090e247 ">Contains all valid <span class="keyword parmname">Destination</span> objects for the specified <span class="keyword parmname">MarketplaceId</span> that you previously registered by calling the <span class="keyword apiname">RegisterDestination</span> operation.
