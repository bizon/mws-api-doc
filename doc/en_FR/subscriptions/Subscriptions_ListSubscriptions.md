...
returns all the subscriptions that you have created by using the
<span class="keyword apiname">CreateSubscription</span> operation.
...
<tbody>
<tr class="odd">
<td><span class="keyword parmname">SubscriptionList</span></td>
<td>A list of all current subscriptions for the specified <span class="keyword parmname">MarketplaceId</span>.
<p>Type: List of <a href="Subscriptions_Datatypes.html#Subscription" class="xref" title="Represents the type of notification that you want to receive and the location where you want to receive it.">Subscription</a></p></td>
</tr>
</tbody>
</table>
