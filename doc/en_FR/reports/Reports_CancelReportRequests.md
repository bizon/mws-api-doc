...
<td>A non-negative integer that represents the total number of report requests that were canceled.
<p><span class="ph">Type: xs:nonNegativeInteger</span></p></td>
</tr>
<tr class="even">
<td><span class="keyword parmname">ReportRequestInfo</span></td>
<td>Detailed information about a report request that was canceled.
...
[GetReport](../reports/Reports_GetReport.html)
